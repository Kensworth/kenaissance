...
<body>
	<div class="as_wrapper">
		<form name = "logins" action = "confirm.php" method = "post">
			<div id="account">
				<span> 
					Sorry, but our backend isn't hooked up to the webserver yet. <br />
					Check back soon! Or follow our <a href = "https://github.com/Kensworth">Github</a> to keep up with our progress. <br />
				</span>
			</div>
			<table class="mytable">
			<tr>
